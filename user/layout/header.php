    ...
    <head>
        ...
        <style>
            footer {
                ...
                text-align: center;
                padding: 20px;
                margin-top: 100px; /* sesuaikan dengan ketinggian konten utama halaman */
            }
        </style>
    </head>
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top">Glamour Shop</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="barang.php">Barang</a></li>
